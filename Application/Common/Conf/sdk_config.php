...
//定义回调URL通用的URL
define('URL_CALLBACK', 'http://' . $_SERVER['SERVER_NAME'] . '/project/?s=/Home/Three/callback/type/');
//define('URL_CALLBACK', U('Home/Three/callback','','',true).'/type/');
...
return array(
    ...
    'THINK_SDK_WEIXIN' => array(
        'APP_KEY' => '123', //应用注册成功后分配的 APP ID
        'APP_SECRET' => '123', //应用注册成功后分配的KEY
    ...
    'THINK_SDK_SINA' => array(
        'APP_KEY' => '464170819', //应用注册成功后分配的 APP ID
        'APP_SECRET' => '2f101ca8caf52182b495906c6633af22', //应用注册成功后分配的KEY
